...
export const ASSETS_CONFIG: (Omit<Asset, 'price' | 'change24h'> & { yahooSymbol: string; industry?: string; marketCap?: string })[] = [
  ...
  { id: 'VRT', symbol: 'VRT', name: 'Vertiv', category: AssetCategory.US_STOCKS, yahooSymbol: 'VRT', industry: '数据中心/液冷', marketCap: '大市值' },
  { id: 'ETN', symbol: 'ETN', name: 'Eaton', category: AssetCategory.US_STOCKS, yahooSymbol: 'ETN', industry: '电气化设备', marketCap: '大市值' },
  { id: 'VST', symbol: 'VST', name: 'Vistra', category: AssetCategory.US_STOCKS, yahooSymbol: 'VST', industry: '电力生产', marketCap: '大市值' },
  { id: 'CEG', symbol: 'CEG', name: 'Constellation Energy', category: AssetCategory.US_STOCKS, yahooSymbol: 'CEG', industry: '核电', marketCap: '大市值' },
  { id: 'PWR', symbol: 'PWR', name: 'Quanta Services', category: AssetCategory.US_STOCKS, yahooSymbol: 'PWR', industry: '电网建设', marketCap: '大市值' },
  { id: 'GE', symbol: 'GE', name: 'GE Aerospace', category: AssetCategory.US_STOCKS, yahooSymbol: 'GE', industry: '航空发动机', marketCap: '大市值' },
  { id: 'NFLX', symbol: 'NFLX', name: 'Netflix', category: AssetCategory.US_STOCKS, yahooSymbol: 'NFLX', industry: '流媒体/科技', marketCap: '大市值' },
  { id: 'UBER', symbol: 'UBER', name: 'Uber', category: AssetCategory.US_STOCKS, yahooSymbol: 'UBER', industry: '出行/共享经济', marketCap: '大市值' },
  { id: 'DASH', symbol: 'DASH', name: 'DoorDash', category: AssetCategory.US_STOCKS, yahooSymbol: 'DASH', industry: '本地生活/配送', marketCap: '大市值' },
  { id: 'SPOT', symbol: 'SPOT', name: 'Spotify', category: AssetCategory.US_STOCKS, yahooSymbol: 'SPOT', industry: '音频/流媒体', marketCap: '大市值' },
  { id: 'ABNB', symbol: 'ABNB', name: 'Airbnb', category: AssetCategory.US_STOCKS, yahooSymbol: 'ABNB', industry: '旅宿/共享经济', marketCap: '大市值' },
  ...
  { id: 'ONON', symbol: 'ONON', name: 'On Holding', category: AssetCategory.US_STOCKS, yahooSymbol: 'ONON', industry: '运动服饰', marketCap: '大市值' },
  { id: 'DECK', symbol: 'DECK', name: 'Deckers', category: AssetCategory.US_STOCKS, yahooSymbol: 'DECK', industry: '运动服饰/Hoka', marketCap: '大市值' },
  { id: 'CMG', symbol: 'CMG', name: 'Chipotle', category: AssetCategory.US_STOCKS, yahooSymbol: 'CMG', industry: '餐饮', marketCap: '大市值' },
  { id: 'MA', symbol: 'MA', name: 'Mastercard', category: AssetCategory.US_STOCKS, yahooSymbol: 'MA', industry: '支付/金融科技', marketCap: '大市值' },
  { id: 'MSTR', symbol: 'MSTR', name: 'MicroStrategy', category: AssetCategory.US_STOCKS, yahooSymbol: 'MSTR', industry: '加密/比特币', marketCap: '大市值' },
  { id: 'COIN', symbol: 'COIN', name: 'Coinbase', category: AssetCategory.US_STOCKS, yahooSymbol: 'COIN', industry: '加密/交易所', marketCap: '大市值' },
  { id: 'SQ', symbol: 'SQ', name: 'Block', category: AssetCategory.US_STOCKS, yahooSymbol: 'SQ', industry: '支付/比特币', marketCap: '大市值' },
  { id: 'HOOD', symbol: 'HOOD', name: 'Robinhood', category: AssetCategory.US_STOCKS, yahooSymbol: 'HOOD', industry: '金融科技/交易', marketCap: '大市值' },
  { id: 'KKR', symbol: 'KKR', name: 'KKR & Co', category: AssetCategory.US_STOCKS, yahooSymbol: 'KKR', industry: '另类资产管理', marketCap: '大市值' },
  { id: 'BX', symbol: 'BX', name: 'Blackstone', category: AssetCategory.US_STOCKS, yahooSymbol: 'BX', industry: '另类资产管理', marketCap: '大市值' },
  ...
  { id: 'PLTR', symbol: 'PLTR', name: 'Palantir', category: AssetCategory.US_STOCKS, yahooSymbol: 'PLTR', industry: '软件/大数据', marketCap: '大市值' },
  { id: 'APP', symbol: 'APP', name: 'AppLovin', category: AssetCategory.US_STOCKS, yahooSymbol: 'APP', industry: '软件/AI广告', marketCap: '大市值' },
  { id: 'NOW', symbol: 'NOW', name: 'ServiceNow', category: AssetCategory.US_STOCKS, yahooSymbol: 'NOW', industry: '软件/SaaS', marketCap: '大市值' },
  { id: 'CRWD', symbol: 'CRWD', name: 'CrowdStrike', category: AssetCategory.US_STOCKS, yahooSymbol: 'CRWD', industry: '网络安全', marketCap: '大市值' },
  { id: 'PANW', symbol: 'PANW', name: 'Palo Alto Networks', category: AssetCategory.US_STOCKS, yahooSymbol: 'PANW', industry: '网络安全', marketCap: '大市值' },
  ...
  { id: 'TSM', symbol: 'TSM', name: 'TSMC', category: AssetCategory.US_STOCKS, yahooSymbol: 'TSM', industry: '半导体/晶圆代工', marketCap: '大市值' },
  { id: 'MU', symbol: 'MU', name: 'Micron', category: AssetCategory.US_STOCKS, yahooSymbol: 'MU', industry: '半导体/存储', marketCap: '大市值' },
  { id: 'MRVL', symbol: 'MRVL', name: 'Marvell', category: AssetCategory.US_STOCKS, yahooSymbol: 'MRVL', industry: '半导体/光互连', marketCap: '大市值' },
  { id: 'ARM', symbol: 'ARM', name: 'Arm Holdings', category: AssetCategory.US_STOCKS, yahooSymbol: 'ARM', industry: '半导体/架构', marketCap: '大市值' },
  { id: 'LRCX', symbol: 'LRCX', name: 'Lam Research', category: AssetCategory.US_STOCKS, yahooSymbol: 'LRCX', industry: '半导体设备', marketCap: '大市值' },
  { id: 'KLAC', symbol: 'KLAC', name: 'KLA Corp', category: AssetCategory.US_STOCKS, yahooSymbol: 'KLAC', industry: '半导体设备/检测', marketCap: '大市值' },
  ...
  { id: 'VRTX', symbol: 'VRTX', name: 'Vertex', category: AssetCategory.US_STOCKS, yahooSymbol: 'VRTX', industry: '医药/罕见病', marketCap: '大市值' },
  { id: 'SYK', symbol: 'SYK', name: 'Stryker', category: AssetCategory.US_STOCKS, yahooSymbol: 'SYK', industry: '医疗设备/骨科', marketCap: '大市值' },
